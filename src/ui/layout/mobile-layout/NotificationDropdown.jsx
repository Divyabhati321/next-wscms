...
const NotificationDropdown = ({ IsAuthenticate, examname }) => {
  ...
  return IsAuthenticate ? (
    ...
    >
      <DropdownTrigger aria-label="user-info" >
        <div aria-label="user-info" className="cursor-pointer bg-[#006ac91a] w-fit p-2 rounded-[10px] flex flex-col gap-1 z-50 relative">
          <svg
      ...
      <DropdownMenu
        ...
        className="p-3 shadow-lg bg-white rounded-lg"
      ...
      >
        <DropdownSection aria-label="Profile & Actions">
                ...
                <div className="flex items-center gap-2">
                  <span>
                    ...
                    >
                      ...
                      />
                      <path
                        d="M30.5902 32C30.5902 28.13 26.7402 25 22.0002 25C17.2602 25 13.4102 28.13 13.4102 32"
                        stroke="#45464E"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div>
                    <p className="block text-[#45464E] text-[16px] font-semibold">
          ...
          <DropdownItem
            ...
            className={`capitalize text-[12px] my-3 text-primary p-2 border-[1.5px] border-primary text-center block rounded-[8px] font-semibold hover:${examname === 'pte' ? 'bg-pte' : examname === 'ielts' ? 'bg-ielts' : 'bg-[#006ac9]'} hover:text-white`}
          >
            <Link
              href={process.env.NEXT_PUBLIC_TEST_PREP_DASHBOARD}
          ...
          <DropdownItem
            ...
            key="logout"
            textValue="logout"
            className={`group text-[15px] text-primary p-2  text-center block rounded-[8px] bg-[#006ac91a] font-medium hover:bg-[#006ac9] hover:text-white`}
          >
            <div
    ...
    <Button
      ...
      className="bg-[#006ac91a] inline-block p-2 min-w-[43px] rounded-[10px] gap-1"
      onClick={() =>
